...
script9_Beef="/Shell_Scripts/Metasploit.sh"
...
script_paths = {"$script1_metasploit", "$script2_nikto", "$script3_unix_privesc_check", "$script4_LinEnum", "$script5_sql", "$script6_LinPEAS", 
                "$script7_Bettercap", "$script8_Responder", "$script9_Beef", "$script10_Acunetix", "$script11_pwndrop", "$script12_Impacket",
                "$script13_Dirb", "$script14_Sherlock", "$script15_Spiderfoot", "$script16_Steghide", "$script17_theHarvester", 
                "$script18_Linux_Exploit_Suggester", "$script19_Linux_Smart_Enumeration"}
